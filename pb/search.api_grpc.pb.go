...
const (
	SearchService_SearchOrders_FullMethodName = "/pb.SearchService/SearchOrders"
	SearchService_GetOrder_FullMethodName     = "/pb.SearchService/GetOrder"
)
